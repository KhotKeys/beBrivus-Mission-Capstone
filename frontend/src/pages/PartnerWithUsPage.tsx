    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white relative overflow-x-hidden">
        ...
        <div className="relative z-10">
          ...
          {/* CTA Section */}
          <div id="contact" className="bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-800 text-white py-16 sm:py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8 border border-white/20 max-w-md mx-auto">
                <div className="space-y-4 text-left">
                  <div className="flex items-center">
                    <Mail className="w-5 h-5 mr-3 flex-shrink-0" />
                    <div>
                      <div className="text-sm text-white/70">Email</div>
                      <a href="mailto:partnerships@bebrivus.com" className="hover:text-white/80 transition-colors">
                        partnerships@bebrivus.com
                      </a>
                    </div>
                  </div>
                  <div className="flex items-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a
                  href="/contact"
                  className="inline-flex items-center px-8 py-4 bg-white text-primary-600 font-semibold rounded-xl hover:bg-neutral-50 transition-all shadow-lg hover:shadow-xl"
                >
                  Schedule a Partnership Call
                  <ArrowRight className="w-5 h-5 ml-2" />
                </a>
                <a
                  href="mailto:partnerships@bebrivus.com"
                  className="inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-xl hover:bg-white/20 transition-all border-2 border-white/20"
                >
                  Send Us a Message
                </a>
              </div>
