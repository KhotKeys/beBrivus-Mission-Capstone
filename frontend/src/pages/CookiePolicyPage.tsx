      ...
      <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white py-12 sm:py-16 lg:py-20 relative overflow-x-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-warning-500 to-warning-600 rounded-2xl mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
            ...
            {/* Contact Information */}
            <section className="bg-warning-50 rounded-xl p-6">
              <h2 className="text-2xl font-bold text-secondary-900 mb-4">
