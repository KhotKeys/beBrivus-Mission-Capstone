    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4 max-[360px]:w-12 max-[360px]:h-12">
            <Bot className="w-8 h-8 text-primary-600 max-[360px]:w-6 max-[360px]:h-6" />
          </div>
          <h1 className="text-4xl font-bold text-secondary-900 mb-4 max-[360px]:text-xl">
            AI Career Coach
          </h1>
          <p className="text-lg text-secondary-600 max-w-2xl mx-auto max-[360px]:text-xs">
            ...
            {messages.map((message) => (
              ...
              >
                <div
                  ...
                  className={`max-w-xs lg:max-w-md px-4 py-3 rounded-lg max-[360px]:px-3 max-[360px]:py-2 max-[360px]:text-xs ${
                    message.role === "user"
