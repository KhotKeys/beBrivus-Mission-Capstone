            ...
            <div className="text-left lg:pr-8">
              ...
              {!isAuthenticated ? (
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/register">
                    <Button className="group relative px-8 py-4 bg-gradient-to-r from-secondary-500 to-secondary-600 hover:from-secondary-600 hover:to-secondary-700 active:from-secondary-700 active:to-secondary-800 text-white font-semibold rounded-xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-secondary-500/25 active:scale-95 active:shadow-lg cursor-pointer">
                  ...
                  <Link to="/opportunities">
                    <Button className="px-8 py-4 bg-white/10 backdrop-blur-sm hover:bg-white/20 active:bg-white/30 text-white font-semibold rounded-xl border border-white/20 hover:border-white/40 active:border-white/60 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer">
                ...
                <Link to="/dashboard">
                  <Button className="group px-8 py-4 bg-gradient-to-r from-secondary-500 to-secondary-600 hover:from-secondary-600 hover:to-secondary-700 active:from-secondary-700 active:to-secondary-800 text-white font-semibold rounded-xl shadow-2xl transform transition-all duration-300 hover:scale-105 active:scale-95 active:shadow-lg hover:shadow-secondary-500/25 cursor-pointer">
                    <span className="flex items-center">
                      Go to Dashboard
                      <ArrowRight className="ml-2 w-5 h-5 transition-transform group-hover:translate-x-1" />
                    </span>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center">
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link to="/register">
                  <Button className="group relative px-12 py-6 bg-gradient-to-r from-secondary-500 to-secondary-600 hover:from-secondary-600 hover:to-secondary-700 active:from-secondary-700 active:to-secondary-800 text-white text-xl font-bold rounded-2xl shadow-2xl transform transition-all duration-300 hover:scale-110 active:scale-90 active:shadow-lg hover:shadow-secondary-500/30 cursor-pointer">
                    <span className="flex items-center">
                      Apply Now - It's Free
